...
![CI](https://github.com/wemnyelezxnpm/aspernatur-eaque-cum/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@wemnyelezxnpm/aspernatur-eaque-cum.svg?style=flat)](https://www.npmjs.com/package/@wemnyelezxnpm/aspernatur-eaque-cum)
...
```
npm i @wemnyelezxnpm/aspernatur-eaque-cum
```
...
const {
  createWarning,
  createDeprecation
} = require('@wemnyelezxnpm/aspernatur-eaque-cum')
...
```js
const { createWarning } = require('@wemnyelezxnpm/aspernatur-eaque-cum')
